...
function () {
    ...
    if (config('backpack.base.setup_dashboard_routes')) {
        ...
        Route::get('website/footer', 'WebsiteController@footer')->name('backpack.website.footer');
        Route::get('/', 'AdminController@redirect')->name('backpack');

        Route::post('/business-settings/update', 'WebsiteController@update')->name('business_settings.update');
    }
