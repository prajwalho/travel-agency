    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="text-center mb-3">
                ...
                @endphp
                <a href="{{ route('home') }}">
                    @if ($header_logo && file_exists(public_path($header_logo)))
                        <img src="{{ asset($header_logo) }}" style="max-height: 75px;" alt="{{ config('app.name') }}" />
                    @else
                        <img src="{{ asset('assets/images/logo-champadevi.png') }}" style="max-height: 75px;"
                            alt="{{ config('app.name') }}" />
                    @endif
                </a>
            </h3>
            <div class="card" style="background-color: #55b193;">
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div>
                                <button type="submit" class="btn btn-block btn-primary"
                                    style="background-color: #0094de; border-color: #0094de;">
