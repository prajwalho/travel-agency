...
<li class="nav-item nav-dropdown">
    ...
    <ul class="nav-dropdown-items">
        <li class="nav-item"><a class="nav-link" href="{{url(config('backpack.base.route_prefix','admin').'/language')}}"><i class="nav-icon la la-files-o"></i> <span>Languages</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{url(config('backpack.base.route_prefix','admin').'/language/texts')}}"><i class="nav-icon la la-files-o"></i> <span>Language File</span></a></li>
    </ul>
</li>
